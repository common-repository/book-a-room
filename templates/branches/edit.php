...
$branchID		= ( isset( $branchInfo['branchID'] ) )			? $branchInfo['branchID']  : null;
$branchDesc		= ( isset( $branchInfo['branchDesc'] ) )		? $branchInfo['branchDesc'] : null;
$branchAddress	= ( isset( $branchInfo['branchAddress'] ) )		? $branchInfo['branchAddress'] : null;
$branchMapLink	= ( isset( $branchInfo['branchMapLink'] ) )		? $branchInfo['branchMapLink'] : null;
$branchImageURL	= ( isset( $branchInfo['branchImageURL'] ) )	? $branchInfo['branchImageURL'] : null;


?>
<form id="form1" name="form1" method="post" action="?page=bookaroom_Settings_Branches&branchID=<?PHP echo $branchID; ?>&action=<?php echo $action; ?>">
	<table class="tableMain">
		...
		<tr>
			...
			<td colspan="2"><input name="branchDesc" type="text" id="branchDesc" value="<?php echo $branchDesc; ?>" size="50" maxlength="64"/>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td colspan="2">
				<textarea name="branchAddress" cols="50" rows="3" id="branchAddress"><?php echo $branchAddress; ?></textarea>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td colspan="2"><input name="branchMapLink" type="text" id="branchMapLink" value="<?php echo $branchMapLink; ?>" size="50"/>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td colspan="2"><input name="branchImageURL" type="text" id="branchImageURL" value="<?php echo $branchImageURL; ?>" size="50"/>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td><input name="branchOpen_<?php echo $num; ?>" type="text" id="branchOpen_<?php echo $num; ?>" value="<?php echo ( isset( $branchInfo["branchOpen_{$num}"] ) ) ? $branchInfo["branchOpen_{$num}"] : null; ?>" size="5" maxlength="5"/>
			...
			<td><input name="branchClose_<?php echo $num; ?>" type="text" id="branchClose_<?php echo $num; ?>" value="<?php echo ( isset( $branchInfo["branchClose_{$num}"] ) ) ? $branchInfo["branchClose_{$num}"] : null; ?>" size="5" maxlength="5"/>
